...
class MuZeroConfig:
    def __init__(self):
        ...
        self.batch_size = 4  # Number of parts of games to train on at each training step
        self.checkpoint_interval = int(100)  # Number of training steps before using the model for self-playing
